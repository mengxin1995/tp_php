    ...
    $("[nctype='btn_special_goods']").live('click', function(){
        ...
        if(link != '') {
            ...
            $.getJSON("index.php?act=cms_special&op=goods_info_by_url", { url: url}, function(data){
                if(data.result == "true") {
                    var temp = '<li nctype="btn_goods_select" style="float: left;width: 237px;padding: 0;margin: 0;border: none;margin: 0 0px 7px 7px; list-style: none;"><dl style="    position: relative;float: left;width: 221px;display: inline;padding: 8px;background: #fff;height: 320px;">';
                    temp += '<dt  class="name" style="  font-size: 14px;position: relative;margin-top: 230px;height: 36px;"><a href="'+data.url+'" target="_blank" style="text-decoration: none;">'+data.title+'</a></dt>';
                    temp += '<dd class="image" style="top: 10px;width: 210px;height: 220px;margin-left: 8px;"><a href="'+data.url+'" target="_blank"><img title="'+data.title+'" src="'+data.image+'" style="width: 220px;height:220px;max-width: 250px;max-height: 250px;"/></a></dd>';
                    temp += '<dd  class="price"style="color: #e30000;font-weight: normal;height: 26px;line-height: 26px;font-size: 24px;margin-top: 10px;height: 40px;position: relative;margin-left: 0px;font-family:"Microsoft Yahei",arial;">￥<span>'+data.price+'</span> ';
                    temp += '<h1  class="label" style="	  position: relative;float: right;background: #ff5783;width: 82px;height: 40px;font-size: 28px;font-weight: normal;text-align: center;line-height: 40px;color: #fff;margin: 0;bottom: 2px;">hot<span class="small"></span><span class="triangle" style="position: absolute;top: 14px;left: -12px;width: 0;height: 0;line-height: 0;border-width: 6px;border-style: dashed;border-color: transparent;border-right-style: solid;border-right-color: #ff5783;"></span></dd>';
