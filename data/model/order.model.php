        ...
        if (in_array('order_goods',$extend)) {
            ...
            if (!empty($order_goods_list)) {
                foreach ($order_goods_list as $value) {
                    //商家货号不再，直接把goods_serial放入到order_goods表
                    //$tmp_goods_info = Model('goods')->getGoodsInfo(array('goods_id'=>$value['goods_id']));//要显示货号,zjcuntao,王国英要求
                    //$value['goods_serial'] = $tmp_goods_info['goods_serial'];//要显示货号,zjcuntao,王国英要求
