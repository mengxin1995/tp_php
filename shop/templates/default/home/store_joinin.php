  ...
  <div class="user-box">
    ...
    <div class="user-joinin">
      ...
      <dl>
        ...
        <dd> 若您还没有填写入驻申请资料<br/>
          请点击“<a href="<?php if($output['is_company']!=0){echo urlShop('store_joinin', 'step0');}else{echo urlShop('store_joinin_c2c', 'step0');}?>" target="_blank">我要入驻</a>”进行入驻资料填写</dd>
        <dd>若您的店铺还未开通<br/>
          请通过“<a href="<?php if($output['is_company']!=0){echo urlShop('store_joinin', 'index');}else{echo urlShop('store_joinin_c2c', 'index');}?>" target="_blank">查看入驻进度</a>”了解店铺开通的最新状况 </dd>
      </dl>
      <div class="bottom"><a href="<?php if($output['is_company']!=0){echo urlShop('store_joinin', 'step0');}else{echo urlShop('store_joinin_c2c', 'step0');}?>" target="_blank">我要入驻</a><a href="<?php if($output['is_company']!=0){echo urlShop('store_joinin', 'index');}else{echo urlShop('store_joinin_c2c', 'index');}?>" target="_blank">查看入驻进度</a></div>
    </div>
     <?php }else { ?>
