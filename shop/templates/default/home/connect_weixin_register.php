...
<div class="nc-login-layout">
  <div class="openid"><span class="avatar"><img src="<?php echo $output['weixin_userinfo']['headimgurl'];?>" /></span><span>您使用微信账号<a href="#register_form"><?php echo $output['qquser_info']['nickname']; ?></a>注册成功，系统为您随机新建商城用户名<br/>
  ...
  <div class="nc-login">
    ...
    <div class="nc-qq-mode">
      <ul class="tabs-nav">
        <li><a href="#register"><?php echo $lang['home_weixinconnect_register_title']; ?><i></i></a></li>
      </ul>
      <div id="tabs_container" class="tabs-container">
        <div id="register" class="tabs-content">
          <form name="register_form" id="register_form" class="nc-login-form" method="post" action="index.php?act=connect_weixin&op=register">
