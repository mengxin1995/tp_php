    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        <tr>
          ...
          <td><input id="seller_name" name="seller_name" type="text" class="w200" value="<?php echo $output['joinin_detail']['seller_name'];?>"/>
            <span></span>
            <p class="emphasis">此账号为日后登录并管理商家中心时使用，注册后不可修改，请牢记。</p></td>
        </tr>
        <tr>
          <th class="w150"><i>*</i>店铺名称：</th>
          <td><input name="store_name" type="text" class="w200" value="<?php echo $output['joinin_detail']['store_name'];?>"/>
            <span></span>
