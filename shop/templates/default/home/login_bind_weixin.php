    ...
    <div class="nc-login-mode">
      ...
      <div id="tabs_container" class="tabs-container">
        <div id="default" class="tabs-content">
          <form id="login_form" class="nc-login-form" method="post" action="<?php echo SHOP_SITE_URL;?>/index.php?act=connect_weixin&op=login">
          ...
          <form class="nc-login-form" method="post" action="<?php echo SHOP_SITE_URL;?>/index.php?act=connect_weixin&op=register">
            <div class="submit-div">
                <input type="submit" class="submit" value="不绑定,使用微信帐号快速注册">
            </div>
          </form>
        </div>
      </div>
