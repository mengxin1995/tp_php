    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        <tr>
          ...
          <td><input name="bank_account_name" type="text" class="w200"  value="<?php echo $output['joinin_detail']['bank_account_name'];?>"/>
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>公司银行账号：</th>
          <td><input name="bank_account_number" type="text" class="w200"  value="<?php echo $output['joinin_detail']['bank_account_number'];?>"/>
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>开户银行支行名称：</th>
          <td><input name="bank_name" type="text" class="w200"  value="<?php echo $output['joinin_detail']['bank_name'];?>"/>
            <span></span></td>
        </tr>
        <!--33hao 简化 tr>
          <th><i>*</i>支行联行号：</th>
        ...
        <tr>
          <th><i>*</i>开户银行所在地：</th>
          <td><input id="bank_address" name="bank_address" type="hidden"  value="<?php echo $output['joinin_detail']['bank_address'];?>"/>
            <span></span></td>
        </tr>
	<!-- 好商城 v3-10 简化-->
        <!--<tr>
    ...
    <div id="div_settlement">
      <table border="0" cellpadding="0" cellspacing="0" class="all">
        ...
        <tbody>
          <tr>
            <th class="w150"><i>*</i>银行开户名：</th>
            <td><input id="settlement_bank_account_name" name="settlement_bank_account_name" type="text" class="w200"  value="<?php echo $output['joinin_detail']['settlement_bank_account_name'];?>"/>
              <span></span></td>
          </tr>
          <tr>
            <th><i>*</i>公司银行账号：</th>
            <td><input id="settlement_bank_account_number" name="settlement_bank_account_number" type="text" class="w200"  value="<?php echo $output['joinin_detail']['settlement_bank_account_number'];?>"/>
              <span></span></td>
          </tr>
          <tr>
            <th><i>*</i>开户银行支行名称：</th>
            <td><input id="settlement_bank_name" name="settlement_bank_name" type="text" class="w200"  value="<?php echo $output['joinin_detail']['settlement_bank_name'];?>"/>
              <span></span></td>
          </tr>
	  <!-- 好商城 v3-10 简化-->
          <!--tr>
          ...
          <tr>
            <th><i>*</i>开户银行所在地：</th>
            <td><input id="settlement_bank_address" name="settlement_bank_address" type="hidden"  value="<?php echo $output['joinin_detail']['settlement_bank_address'];?>"/>
              <span></span></td>
          </tr>
        </tbody>
        <tfoot>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        <tr>
          ...
          <td><input name="tax_registration_certificate" type="text" class="w200"  value="<?php echo $output['joinin_detail']['tax_registration_certificate'];?>"/>
            <span></span></td>
        </tr>
	<!--好商城 v3-10 简化-->
        <!--tr>
        ...
        <tr>
          <th><i>*</i>税务登记证号电子版：</th>
          <td><input name="tax_registration_certificate_electronic" type="file" /><input name="tax_registration_certificate_electronic2" type="hidden"  value="<?php echo $output['joinin_detail']['tax_registration_certificate_electronic'];?>" />
            <span class="block">请确保图片清晰，文字可辨并有清晰的红色公章。</span></td>
        </tr>
      </tbody>
      <tfoot>
