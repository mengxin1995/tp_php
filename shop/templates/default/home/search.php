...
<div class="nch-container wrapper" >
  <div class="left">
    ...
    <div class="nch-module">
      ...
      <?php }else if($output['current_site']['site_id'] == '1'){?>
        <?php echo loadadv(37,'html');?>
        <?php echo loadadv(47,'html');?>
      <?php } else if($output['current_site']['site_id'] == '2'){?>
        <?php echo loadadv(37,'html');?>
        <?php echo loadadv(57,'html');?>
      <?php } ?>
    </div>
    <!-- 最近浏览 -->
  ...
  <div class="right">
    ...
    <div class="shop_con_list" id="main-nav-holder">
	  ...
	  <?php if(!empty($_GET['keyword'])&&!empty($output['taobaoke_item_list'])){ ?>
      <div class="tc mt20 mb20">
        <div style="display:block;background-color:#D93600;color:#FFF;height:28px;font-size:18px;">以下数据来自淘宝网 </div>
      </div>
      <div>
        <?php require_once (BASE_TPL_PATH.'/home/goods.squarestaobao.php');?>
      </div>
	  <?php } ?>
    </div>
