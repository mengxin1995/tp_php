...
<div class="ncc-main">
  <div class="ncc-title">
    ...
    <input value="<?php echo $output['fee_goods_id_list'];?>" name="fee_goods_id_list" type="hidden">
</div>
</form>
...
function calcOrder() {
    ...
    var available_amount = $('#available_amount').html();

    if(available_amount>=allTotal){$('#pd_panel').show();$('#pd_panel_2').hide();}else{$('#pd_panel').hide();$('#pd_panel_2').show();}
}
$(function(){
    $.ajaxSetup({
        async : false
