...
<div class="ncc-main">
 <div class="ncc-title">
  ...
  <div class="ncc-bottom"><a id="submitOrder" href="javascript:void(0)" class="ncc-btn ncc-btn-acidblue fr">提交订单</a> <a class="ncc-btn ncc-btn-acidblue fr" style="margin-right:2px;font-weight:900;background-color:#FFAA01;border-color:#FFAA01;">★★★重要提示：如果要使用【<span style="color:#FF0000;">预存款、充值卡、F码、代金券</span>】，请在这一步操作，订单提交后将无法再使用。★★★</a></div>
