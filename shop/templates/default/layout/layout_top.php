...
<div id="ncToolbar" class="nc-appbar">
  <div class="nc-appbar-tabs" id="appBarTabs">
    ...
    <div class="variation">
        <div class="cart"><a href="<?php echo SHOP_SITE_URL;?>/index.php?site_id=<?php echo $output['current_site']['site_id'];?>" id="rtoolbar_cart"> <span class="name">村村兔首页</span></a></div>
      <div class="middle">
    ...
    <div class="user-login-box" nctype="barLoginBox" style="display:none;"> <i class="arrow"></i> <a href="javascript:void(0);" class="close" nctype="close-barLoginBox" title="关闭">X</a>
      <form id="login_form" method="post" action="index.php?act=login&op=login" onsubmit="ajaxpost('login_form', '', '', 'onerror')">
        ...
        <div class="bottom">
          ...
          <a class="mr20" title="微信账号登录" href="<?php echo SHOP_SITE_URL;?>/api.php?act=toweixin">微信</a>
          <?php } ?>
  ...
  <div class="topbar wrapper">
    <div class="user-entry">
      ...
      <div class="multi-site">
          <dl>
              <dt><a href="<?php echo SHOP_SITE_URL;?>/index.php?site_id=<?php echo $output['current_site']['site_id'];?>">[<span style="color:red;"><?php echo $output['current_site']['site_name'];?></span>]</a><i></i></dt>
              <dd>
                  <ul>
                  <?php if(is_array($output['site_list'])){ ?>
                      <?php foreach($output['site_list'] as $k => $v){ ?>
                          <?php if($v['site_name']!="总站"&&$v['site_id']!=0) { ?><!--隐藏总站开始-->
                          <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?site_id=<?php echo $v['site_id'];?>">[<?php echo $v['site_name'];?>]</a></li>
                          <?php } ?><!--隐藏总站结束-->
                      <?php } ?>
                  <?php } ?>
                  </ul>
    ...
    <div class="quick-menu" >
        <dl>
            <dt ><a href="<?php echo SHOP_SITE_URL;?>/index.php?site_id=<?php echo $output['current_site']['site_id'];?>" ><span style="color:#FF0000">村村兔首页</span></a></dt>
        </dl>
      <dl>
