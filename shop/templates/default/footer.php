...
<script type="text/javascript">
    (function(win,doc){
        ...
        var o = {
            pid: "mm_13859000_11242339_39756517",/*推广单元ID，用于区分不同的推广渠道*/
            appkey: "23253574",/*通过TOP平台申请的appkey，设置后引导成交会关联appkey*/
            unid: "<?php echo $_SESSION['member_id'];?>",/*自定义统计字段*/
