        ...
        <dl>
          ...
          <dd>
            <div class="alert alert-info m0">
              ...
              <p class="mt5" title="<?php echo $lang['store_deliver_buyer_address'];?>"><i class="icon-map-marker"></i><?php echo $order['extend_order_common']['reciver_info']['address'];?>[自提服务站]</span>&nbsp;站长姓名：<?php echo $order['extend_order_common']['reciver_info']['station_name'];?></span>,&nbsp;站长电话：<?php echo $order['extend_order_common']['reciver_info']['mob_phone']==''?$order['extend_order_common']['reciver_info']['tel_phone']:$order['extend_order_common']['reciver_info']['mob_phone'];?></span></p>
