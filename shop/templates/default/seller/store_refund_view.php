  ...
  <div class="ncsc-flow-container">
    ...
    <div class="ncsc-form-default">
      ...
      <dl>
        ...
        <dd> <?php echo $output['state_array'][$output['refund']['seller_state']]; ?>
		<?php if($output['refund']['seller_state']==2 && $output['refund']['refund_state']<3){?> 
		<form id="post_form" method="post" action="index.php?act=store_refund&op=edit2&refund_id=<?php echo $output['refund']['refund_id']; ?>">
		  <label class="submit-border">
            <a class="submit" id="confirm_button">取消同意</a>
          </label>
		</form>
