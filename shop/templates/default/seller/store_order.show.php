...
<div>
  ...
  <textarea  disabled="disabled" style="width:350px;height:40px;">
    商家备注：
    <?php
    if ($output['order_info']['seller_message'] != NULL)
      echo $output['order_info']['seller_message'];
    ?>
  </textarea><br />
  <a href="index.php?act=store_order&op=seller_message&order_id=<?php echo $output['order_info']['order_id']?>" style="display:block;height:23px;line-height:23px;width:60px;border:1px #ccc solid;background:#e5e5e5;text-align:center;color:#000;margin:5px 0 5px 0;">商家备注</a>
</div>
