...
<div class="alert alert-info mt10" style="clear:both;">
    ...
    <li>
    	<span class="w210 fl h30" style="display:block;">
    		<i title="店铺在该时间段内有效订单的总金额" class="tip icon-question-sign"></i>
    		该时间段下单金额：<strong><?php echo $output['stat_count']['ordergamount'].$lang['currency_zh'];?></strong>
    	</span>
		<span class="w210 fl h30" style="display:block;">
			<i title="店铺在该时间段内有效订单的总商品数量" class="tip icon-question-sign"></i>
			该时间段下单商品数：<strong><?php echo $output['stat_count']['ordergoodsnum'];?></strong>
		</span>
		<span class="w210 fl h30" style="display:block;">
			<i title="店铺在该时间段内有效订单的总订单数" class="tip icon-question-sign"></i>
			该时间段下单量：<strong><?php echo $output['stat_count']['ordernum'];?></strong>
		</span>
    </li>
    </ul>
