      ...
      <div class="ncsc-form-default">
        ...
        <dl>
          ...
          <dd> <?php echo $output['state_array'][$output['return']['seller_state']]; ?>
              <?php if($output['return']['seller_state']==2 && $output['return']['refund_state']<3){?>
                  <form id="post_form" method="post" action="index.php?act=store_return&op=edit2&refund_id=<?php echo $output['return']['refund_id']; ?>">
