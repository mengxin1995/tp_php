...
<div class="print-layout">
  <div class="print-page">
    <div id="printarea">
	  ...
	  <div style="position:absolute;padding-left:8mm;padding-top:2mm;display:none;"><img src="../barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Verdana.ttf&font_size=12&thickness=50&code=BCGcode93&text=<?php echo urlencode($output['order_info']['order_sn']);?>"/></div>
	  <div style="position:absolute;padding-left:150mm;display:none;"><img style="width:135px;height:135px;" src="../phpqrcode/img.php?data=<?php echo urlencode('http://wuliu.cuncuntu.com/index.php?g=&m=Order&a=s&order_id='.$output['order_info']['order_sn']);?>"/></div>
        <div class="top">
        ...
        <table class="buyer-info" style="margin-top: 0px;">
          <tr>
            ...
            <td><?php echo '电话'.$lang['nc_colon']; ?><?php echo @$output['order_info']['extend_order_common']['reciver_info']['phone'];?><span style="color:#FFF;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>买家ID：<?php echo $output['order_info']['buyer_name'];?></td>
            <td></td>
          </tr>
          <tr>
            <td colspan="3">发&nbsp;&nbsp;&nbsp;&nbsp;票： <?php foreach ((array)$output['order_info']['extend_order_common']['invoice_info'] as $key => $value){?>
          ...
          <tr>
            <td colspan="3">
              买家留言：<?php echo @$output['order_info']['extend_order_common']['order_message']; ?>
            </td>
          </tr>
          <tr>
