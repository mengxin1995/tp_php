...
<div class="ncsc-flow-layout">
  <div class="ncsc-flow-container">
    <div class="title">
      <!--<h3>物流详情</h3><span class="fr mr5"> <a href="<?php echo urlShop('store_deliver', 'waybill_print', array('order_id' => $output['order_info']['order_id']));?>" class="ncsc-btn-mini" target="_blank" title="打印运单"/><i class="icon-print"></i>打印运单</a></span>-->
      <h3>物流详情</h3><span class="fr mr5"> <a href="<?php if($output['e_code']=='cct'){echo urlShop('store_deliver', 'waybill_print', array('order_id' => $output['order_info']['order_id']));}else{echo urlShop('store_deliver', 'waybill_print_old', array('order_id' => $output['order_info']['order_id'],'expresstype'=>$output['e_name']));}?>" class="ncsc-btn-mini" target="_blank" title="打印运单"/><i class="icon-print"></i>打印运单</a></span>
