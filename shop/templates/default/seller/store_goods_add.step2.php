...
<div class="item-publish">
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlShop('store_goods_online', 'edit_save_goods');} else { echo urlShop('store_goods_add', 'save_goods');}?>">
    ...
    <!--商品锁状态 -->
    <input type="hidden" name="lock_type" id="lock_type" value="<?php echo $output['goods']['goods_lock'];?>" />
    ...
    <div class="ncsc-form-goods">
      ...
      <dl>
        <!--商品价格 -->
        <?php if($output['goods']['goods_lock']==2||$output['goods']['goods_lock']==4){ ?>
          <dt nc_type="no_spec"><i class="required">*</i><?php echo $lang['store_goods_index_store_price'].$lang['nc_colon'];?></dt>
          <dd nc_type="no_spec">
            <input name="g_price" readonly="readonly" value="<?php echo $output['goods']['goods_price']; ?>" type="text"  class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
            <p class="hint" style="color: red">此商品价格被锁定，无法更改</p>
          </dd>
        <?php }else{ ?>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo $lang['store_goods_index_store_price'].$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
        ...
        <dd class="spec-dd">
          ...
          <table border="0" cellpadding="0" cellspacing="0" class="spec_table">
            ...
            <th nctype="spec_name_<?php echo $k;?>"><?php if (isset($output['goods']['spec_name'][$k])) { echo $output['goods']['spec_name'][$k];} else {echo $val['sp_name'];}?></th>
              <?php }?>
              <?php }?>
              <th class="w80"><span class="red">*</span>市场价
              ...
              <th class="w80"><span class="red">*</span><?php echo $lang['store_goods_index_price'];?>
                <div class="batch"><i class="icon-edit" title="批量操作"></i>
                  <div class="batch-input" style="display:none;">
                    <h6>批量设置价格：</h6>
                    <a href="javascript:void(0)" class="close">X</a>
              ...
              <th class="w70">库位
                <div class="batch"><i class="icon-edit" title="批量操作"></i>
                  <div class="batch-input" style="display:none;">
                    <h6>批量设置库位：</h6>
                    <a href="javascript:void(0)" class="close">X</a>
                    <input name="" type="text" class="text w60" />
                    <a href="javascript:void(0)" class="ncsc-btn-mini" data-type="stock_position">设置</a><span class="arrow"></span></div>
                </div></th>
              <th class="w70"><?php echo $lang['store_goods_index_goods_no'];?>
                <div class="batch"><i class="icon-edit" title="批量操作"></i>
                  <div class="batch-input" style="display:none;">
                    <h6>批量设置商家货号：</h6>
                    <a href="javascript:void(0)" class="close">X</a>
                    <input name="" type="text" class="text w60" />
                    <a href="javascript:void(0)" class="ncsc-btn-mini" data-type="sku">设置</a><span class="arrow"></span></div>
                </div>
              </th>
              <th class="w100"><?php echo $lang['store_goods_index_goods_barcode'];?>
                <div class="batch"><i class="icon-edit" title="批量操作"></i>
                  <div class="batch-input" style="display:none;">
                    <h6>批量设置商品条码：</h6>
                    <a href="javascript:void(0)" class="close">X</a>
                    <input name="" type="text" class="text w60" />
                    <a href="javascript:void(0)" class="ncsc-btn-mini" data-type="barcode">设置</a><span class="arrow"></span></div>
                </div>
              </th>
                </thead>
          ...
          <p class="hint" style="display:inline">点击<i class="icon-edit"></i>可批量修改所在列的值。</p>
          <?php if($output['goods']['goods_lock']==2){ ?>
          <p class="hint"  style="color: red;display:inline">此商品价格被锁定，无法更改</p>
            <?php }elseif($output['goods']['goods_lock']==3){ ?>
            <p class="hint"  style="color: red;display:inline">此商品库存被锁定，无法更改</p>
          <?php }elseif($output['goods']['goods_lock']==4){ ?>
            <p class="hint"  style="color: red;display:inline">商品价格和库存被锁定，无法更改</p>
          <?php } ?>
        </dd>
      </dl>
      <dl>
        <!--商品库存 -->
        <?php if($output['goods']['goods_lock']==3||$output['goods']['goods_lock']==4){ ?>
          <dt nc_type="no_spec"><i class="required">*</i><?php echo $lang['store_goods_index_goods_stock'].$lang['nc_colon'];?></dt>
          <dd nc_type="no_spec">
            <input readonly="readonly" name="g_storage" value="<?php echo $output['goods']['g_storage']; ?>" type="text" class="text w70" />
            <span></span>
            <p class="hint" style="color: red">商品库存已被锁定，无法修改</p>
          </dd>
        <?php }else{ ?>
          <dt nc_type="no_spec"><i class="required">*</i><?php echo $lang['store_goods_index_goods_stock'].$lang['nc_colon'];?></dt>
          <dd nc_type="no_spec">
            <input name="g_storage" value="<?php echo $output['goods']['g_storage']; ?>" type="text" class="text w70" />
            <span></span>
      ...
      <dl>
        ...
        <dd>
          <input name="g_alarm" value="<?php echo $output['goods']['goods_storage_alarm'];?>" type="text" class="text w70" />
          <span></span>
      ...
      <dl>
        <dt>库位<?php echo $lang['nc_colon'];?></dt>
        <dd>
          <input name="g_position" value="<?php echo $output['goods']['goods_position'];?>" type="text" class="text w70" />
          <span></span>
          <p class="hint">商品在仓库的存放位置，方便仓库发货和管理。</p>
        </dd>
      </dl>
      <dl>
      ...
      <dl>
        <dt nc_type="no_spec"><?php echo $lang['store_goods_index_goods_barcode'].$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <p>
            <input name="g_barcode" value="<?php echo $output['goods']['goods_barcode']; ?>" type="text"  class="text"  />
          </p>
          <p class="hint"><?php echo $lang['store_goods_index_goods_barcode_help'];?></p>
        </dd>
      </dl>
      <dl>
...
//表单提交前,ajax获取商品锁定状态
  $('input[type="submit"]').click(function(e){
    ...
    $.ajax({
      type:"GET",
      url:SITEURL+"/index.php?act=store_goods_online&op=getGoodsLockType_ajax",
      data:{commonid:<?php echo $output['goods']['goods_commonid'];?>},
      dataType:"text",
      success:function(data,textStatus){
        if(data==1){
          ...
          showDialog("操作失败，商品参数已被锁定！",'notice','',winBack,'','','','','','','');
        }
        else
        {
          $("#goods_form").submit();
...
function goods_stock_set(){
    ...
    $('input[name="g_position"]').attr('readonly','readonly').css('background','#E7E7E7 none');
    $('dl[nc_type="spec_dl"]').show();
    str = '<tr>';
    <?php recursionSpec(0,$output['sign_i'],$output['goods']['goods_lock']);?>
    if(str == '<tr>'){
        //  店铺价格 商品库存取消只读
        $('input[name="g_price"]').removeAttr('readonly').css('background','');
        $('input[name="g_storage"]').removeAttr('readonly').css('background','');
        $('input[name="g_position"]').removeAttr('readonly').css('background','');
...
function recursionSpec($len,$sign,$lock=0) {
    if($len < $sign){
        ...
        if($lock==2)
        {
          echo "str +='<td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][marketprice]\" data_type=\"marketprice\" nc_type=\"'+spec_bunch+'|marketprice\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td><td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][price]\" style=\"background: rgb(231, 231, 231) none repeat scroll 0% 0%;\" readonly=\"readonly\" data_type=\"price\" nc_type=\"'+spec_bunch+'|price\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td><td><input class=\"text stock\" type=\"text\" name=\"spec['+spec_bunch+'][stock]\" data_type=\"stock\" nc_type=\"'+spec_bunch+'|stock\" value=\"\" /></td><td><input class=\"text stock\" type=\"text\" name=\"spec['+spec_bunch+'][alarm]\" data_type=\"alarm\" nc_type=\"'+spec_bunch+'|alarm\" value=\"\" /></td><td><input class=\"text w70\" type=\"text\" name=\"spec['+spec_bunch+'][stock_position]\" data_type=\"stock_position\"  nc_type=\"'+spec_bunch+'|stock_position\" value=\"\" /></td><td><input class=\"text w70\" type=\"text\" name=\"spec['+spec_bunch+'][sku]\" data_type=\"sku\"  nc_type=\"'+spec_bunch+'|sku\" value=\"\" /></td><td><input class=\"text w70\" type=\"text\" name=\"spec['+spec_bunch+'][barcode]\" data_type=\"barcode\"  nc_type=\"'+spec_bunch+'|barcode\" value=\"\" /></td></tr>';\n";
        }
        elseif($lock==3)
        {
          echo "str +='<td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][marketprice]\" data_type=\"marketprice\" nc_type=\"'+spec_bunch+'|marketprice\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td><td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][price]\"  data_type=\"price\" nc_type=\"'+spec_bunch+'|price\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td><td><input class=\"text stock\" type=\"text\" name=\"spec['+spec_bunch+'][stock]\" style=\"background: rgb(231, 231, 231) none repeat scroll 0% 0%;\" readonly=\"readonly\" data_type=\"stock\" nc_type=\"'+spec_bunch+'|stock\" value=\"\" /></td><td><input class=\"text stock\" type=\"text\" name=\"spec['+spec_bunch+'][alarm]\" data_type=\"alarm\" nc_type=\"'+spec_bunch+'|alarm\" value=\"\" /></td><td><input class=\"text w70\" type=\"text\" name=\"spec['+spec_bunch+'][stock_position]\" data_type=\"stock_position\"  nc_type=\"'+spec_bunch+'|stock_position\" value=\"\" /></td><td><input class=\"text w70\" type=\"text\" name=\"spec['+spec_bunch+'][sku]\" data_type=\"sku\"  nc_type=\"'+spec_bunch+'|sku\" value=\"\" /></td><td><input class=\"text w70\" type=\"text\" name=\"spec['+spec_bunch+'][barcode]\" data_type=\"barcode\"  nc_type=\"'+spec_bunch+'|barcode\" value=\"\" /></td></tr>';\n";
        }
        elseif($lock==4)
        {
          echo "str +='<td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][marketprice]\" data_type=\"marketprice\" nc_type=\"'+spec_bunch+'|marketprice\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td><td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][price]\" style=\"background: rgb(231, 231, 231) none repeat scroll 0% 0%;\" readonly=\"readonly\" data_type=\"price\" nc_type=\"'+spec_bunch+'|price\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td><td><input class=\"text stock\" type=\"text\" name=\"spec['+spec_bunch+'][stock]\" style=\"background: rgb(231, 231, 231) none repeat scroll 0% 0%;\" readonly=\"readonly\"  data_type=\"stock\" nc_type=\"'+spec_bunch+'|stock\" value=\"\" /></td><td><input class=\"text stock\" type=\"text\" name=\"spec['+spec_bunch+'][alarm]\" data_type=\"alarm\" nc_type=\"'+spec_bunch+'|alarm\" value=\"\" /></td><td><input class=\"text w70\" type=\"text\" name=\"spec['+spec_bunch+'][stock_position]\" data_type=\"stock_position\"  nc_type=\"'+spec_bunch+'|stock_position\" value=\"\" /></td><td><input class=\"text w70\" type=\"text\" name=\"spec['+spec_bunch+'][sku]\" data_type=\"sku\"  nc_type=\"'+spec_bunch+'|sku\" value=\"\" /></td><td><input class=\"text w70\" type=\"text\" name=\"spec['+spec_bunch+'][barcode]\" data_type=\"barcode\"  nc_type=\"'+spec_bunch+'|barcode\" value=\"\" /></td></tr>';\n";
        ...
        {
          echo "str +='<td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][marketprice]\" data_type=\"marketprice\" nc_type=\"'+spec_bunch+'|marketprice\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td><td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][price]\"  data_type=\"price\" nc_type=\"'+spec_bunch+'|price\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td><td><input class=\"text stock\" type=\"text\" name=\"spec['+spec_bunch+'][stock]\" data_type=\"stock\" nc_type=\"'+spec_bunch+'|stock\" value=\"\" /></td><td><input class=\"text stock\" type=\"text\" name=\"spec['+spec_bunch+'][alarm]\" data_type=\"alarm\" nc_type=\"'+spec_bunch+'|alarm\" value=\"\" /></td><td><input class=\"text w70\" type=\"text\" name=\"spec['+spec_bunch+'][stock_position]\" data_type=\"stock_position\"  nc_type=\"'+spec_bunch+'|stock_position\" value=\"\" /></td><td><input class=\"text w70\" type=\"text\" name=\"spec['+spec_bunch+'][sku]\" data_type=\"sku\"  nc_type=\"'+spec_bunch+'|sku\" value=\"\" /></td><td><input class=\"text w100\" type=\"text\" name=\"spec['+spec_bunch+'][barcode]\" data_type=\"barcode\"  nc_type=\"'+spec_bunch+'|barcode\" value=\"\" /></td></tr>';\n";
        }
        for($i=0; $i< $len; $i++){
            echo "}\n";
        }
