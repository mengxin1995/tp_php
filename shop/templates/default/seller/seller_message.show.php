...
<form method='post' id='user_form'>
    ...
    <?php foreach($output['order_list'] as $order_id => $order) { ?>
        ...
        <tr>
            <th colspan="20"><span class="ml10">
                    <!---批量打印插件开始--->
                    <?php if ($_GET['state_type'] == 'state_pay'&&$order['lock_state']==0){ ?>
...
<form action="index.php?act=store_order&op=show_order&order_id=<?php echo $output['order']['order_id'];?>" method="post">
    <span style="display:inline-block;width:60px;text-align: right;">标记：</span><input type="radio" name="img[<?php echo $output['order']['order_id'];?>]" value="op_memo_1.png" checked="checked" /><img src="../shop/templates/default/images/seller/op_memo_1.png"  alt="红色" />
    <input type="radio" name="img[<?php echo $output['order']['order_id'];?>]" value="op_memo_2.png"  /><img src="../shop/templates/default/images/seller/op_memo_2.png"  alt="黄色" />
    <input type="radio" name="img[<?php echo $output['order']['order_id'];?>]" value="op_memo_3.png"  /><img src="../shop/templates/default/images/seller/op_memo_3.png"  alt="绿色" />
    <input type="radio" name="img[<?php echo $output['order']['order_id'];?>]" value="op_memo_4.png"  /><img src="../shop/templates/default/images/seller/op_memo_4.png"  alt="蓝色" />
    <input type="radio" name="img[<?php echo $output['order']['order_id'];?>]" value="op_memo_5.png"  /><img src="../shop/templates/default/images/seller/op_memo_5.png"  alt="紫色" />
    ...
    <tr>
        ...
        <td class="tl" colspan="2">
            <textarea  name="pay_message[<?php echo $output['order']['order_id'];?>]" class="ncc-msg-textarea" placeholder="选填：对本次交易的说明（建议填写已经和商家达成一致的说明）" title="选填：对本次交易的说明（建议填写已经和商家达成一致的说明）"  maxlength="150" style="width:400px;height:100px;margin-top:3px;"></textarea></td>
