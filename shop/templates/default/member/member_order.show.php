    ...
    <div class="ncm-order-details">
      ...
      <div class="content">
        <dl>
          ...
          <dd><span><?php echo $output['order_info']['extend_order_common']['reciver_name'];?>，</span><span><?php echo @$output['order_info']['extend_order_common']['reciver_info']['phone'];?>，</span><span><?php echo @$output['order_info']['extend_order_common']['reciver_info']['address'];?></span><span>&nbsp;站长：<?php echo @$output['order_info']['extend_order_common']['reciver_info']['station_name'];?></span><span>&nbsp;电话：<?php echo @$output['order_info']['extend_order_common']['reciver_info']['mob_phone'];?></span></dd>
        </dl>
        <dl>
          <dt>发&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;票：</dt>
          <dd>
