    ...
    <div class="outline">
        ...
        <div class="ncm-friends-share">
            <ul>
                <li>
                    <div>
                        <img  src="../phpqrcode/img.php?data=<?php echo str_replace('&','%26',C('mobile_site_url').'/index.php?act=zjcuntao&op=qrcode&app=yes&station_id='.$_SESSION['member_id']);?>" style="width:190px;height: 190px;">
                    </div>
                </li>
            </ul>
        </div>
