  ...
  <table class="ncm-default-table">
    <thead>
      <tr>
        ...
        <th class="w100"><?php echo $lang['predeposit_recharge_price']; ?>(<?php echo $lang['currency_zh'];?>)</th>
        <th class="w100"><?php echo $lang['predeposit_recharge_real_price']; ?>(<?php echo $lang['currency_zh'];?>)</th>
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="red">+<?php echo $val['pdr_real_amount'];?></td>
