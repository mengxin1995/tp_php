...
<div class="wrap">
  ...
  <div class="alert"><span class="mr30"><?php echo $lang['predeposit_pricetype_available'].$lang['nc_colon']; ?><strong class="mr5 red" style="font-size: 18px;"><?php echo $output['member_info']['available_predeposit']+$output['member_info']['available_rc_balance']; ?></strong><?php echo $lang['currency_zh'];?></span><span><?php echo $lang['predeposit_pricetype_freeze'].$lang['nc_colon']; ?><strong class="mr5 blue" style="font-size: 18px;"><?php echo $output['member_info']['freeze_predeposit']+$output['member_info']['freeze_rc_balance']; ?></strong><?php echo $lang['currency_zh'];?></span></div>
    <!--订单号搜索开始-->
    <form method="get" action="index.php">
        <table class="ncm-search-table">
            ...
            <tr>
                <td>&nbsp;</td>
                <th><?php echo 订单号;?></th>
                <td class="w160 tc"><input type="text" class="text w150" name="lg_desc" value="<?php echo $_GET['"lg_desc"'];?>"/></td>
