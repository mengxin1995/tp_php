...
class store_joininControl extends BaseHomeControl {
    ...
    public function step2Op() {
        ...
        if(!empty($_POST)) {
            ...
            $pic_name = $this->upload_image('business_licence_number_electronic');
            if($pic_name!='') {
                $param['business_licence_number_electronic'] = $pic_name;
            }
            else{
                $param['business_licence_number_electronic'] = $_POST['business_licence_number_electronic2'];
            }
            ...
            $pic_name2 = $this->upload_image('organization_code_electronic');
            if($pic_name2!='') {
                $param['organization_code_electronic'] = $pic_name2;
            }
            else{
                $param['organization_code_electronic'] = $_POST['organization_code_electronic2'];
            }
    ...
    public function step3Op() {
        if(!empty($_POST)) {
            ...
            $pic_name = $this->upload_image('tax_registration_certificate_electronic');
            if($pic_name!='') {
                $param['tax_registration_certificate_electronic'] = $pic_name;
            }
            else{
                $param['tax_registration_certificate_electronic'] = $_POST['tax_registration_certificate_electronic2'];
            }
    ...
    private function step3_save_valid($param) {
        ...
        $obj_validate->validateparam = array(
            ...
            array("input"=>$param['bank_account_number'], "require"=>"true","validator"=>"Length","min"=>"1","max"=>"30","message"=>"银行账号不能为空且必须小于30个字"),
