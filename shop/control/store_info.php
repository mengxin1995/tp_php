...
class store_infoControl extends BaseSellerControl {
	...
	public function indexOp(){
		...
		//print_r($member_id.'  ');
		$company_registered_capital=$model_store_joinin->where(array('member_id'=>$member_id))->select();
        //print_r($company_registered_capital[0]['company_registered_capital']);
		Tpl::output('company_registered_capital',$company_registered_capital[0]['company_registered_capital']);
