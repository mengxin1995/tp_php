...
class seller_loginControl extends BaseSellerControl {
	...
	public function __construct() {
        ...
        if (!empty($_SESSION['seller_id'])) {
            ...
            if(($store_info['store_phone']===null) || ($store_info['store_phone']==='') || ((($store_info['store_qq']===null) || ($store_info['store_qq']==='')) && (($store_info['store_ww']===null) || ($store_info['store_ww']==='')))) {
                redirect('index.php?act=store_required&op=show_form');
            } else {
