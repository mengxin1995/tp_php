...
class indexControl extends BaseHomeControl{
	public function indexOp(){
        ...
        $group_list = $model_groupbuy->getMeiRiYiPin();
		Tpl::output('group_list', $group_list);
		//友情链接
		$model_link = Model('link');
		$link_list = $model_link->getLinkList(null,10);
		//热门晒单 v3-b12
		...
		$web_html = $model_web_config->getWebHtml('index',$site_id);
		Tpl::output('web_html',$web_html);
		Model('seo')->type('index')->show();

		//允许出现alimama代码
		Tpl::output('alimama','yes');
