       ...
       success:function(result){
          ...
          if(!data.error){
            ...
            if (data.goods_info.is_virtual == '1') {
                ...
                data.goods_info.buyLimitation = buyLimitation(data.goods_info.virtual_limit, parseInt(data.goods_info.upper_limit));
            }
            ...
            $(".add-wp").click(function (){
               ...
               if(buynum < data.goods_info.goods_storage){
                   if(typeof(data.goods_info.upper_limit)!='undefined' && buynum>parseInt(data.goods_info.upper_limit-1)){
                       $.sDialog({
                           skin:"red",
                           content:"本商品限购"+data.goods_info.upper_limit+"件",
                           okBtn:false,
                           cancelBtn:false
                       });
                   }
		    ...
		    var havenum = Number(data.goods_info.goods_storage);
                    ...
                    if (buynum > parseInt(data.goods_info.upper_limit)) {
                           $.sDialog({
                               skin:"red",
                               content:'超过限购数量！',
                               okBtn:false,
