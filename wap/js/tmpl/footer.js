$(function (){
	...
	var weixinHtml='';
	if(is_weixn()){
		weixinHtml = '<a class="btn mr5" href="'+SiteUrl+'/shop/api.php?act=toweixin&mobile=mobile">微信登陆</a>';
	}
    var memberHtml = '<a class="btn mr5" href="'+WapSiteUrl+'/tmpl/member/member.html?act=member"">登录</a><a class="btn mr5" href="'+SiteUrl+'/shop/api.php?act=toqq&mobile=mobile">QQ登陆</a>'+weixinHtml+'<a class="btn mr5" href="'+WapSiteUrl+'/tmpl/member/register.html">注册</a>';
    ...
    var tmpl = '<div class="footer">'
        ...
        +'<div class="footer-content">'
            +'<p class="link">'
				...
				+'<a href="'+SiteUrl+'/shop/?pc=true" class="standard">电脑版首页</a>'
