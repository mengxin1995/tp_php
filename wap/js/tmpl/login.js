$(function(){
    ...
    var memberHtml = '<a class="btn mr5" href="'+SiteUrl+'/shop/api.php?act=toqq&mobile=mobile">QQ登陆</a>'+weixinHtml+'<a class="btn mr5" href="'+WapSiteUrl+'/tmpl/member/register.html">注册</a>';
