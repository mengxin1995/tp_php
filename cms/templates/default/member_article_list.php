        ...
        <tr>
          ...
          <td class="handle">
            <?php if($value['article_state'] != '3') {?>
              ...
              <?php } else { ?>
              <a href="<?php echo $article_url;?>" target="_blank" style="color:#06C;"><?php echo $lang['cms_text_view'];?></a> <a href="<?php echo CMS_SITE_URL.DS;?>index.php?act=member_article&op=article_edit&article_id=<?php echo $value['article_id'];?>" style="color:#F90;" ><?php echo $lang['cms_text_edit'];?></a> <a href="<?php echo CMS_SITE_URL.DS;?>index.php?act=member_article&op=article_recycle&article_id=<?php echo $value['article_id'];?>" style="color:#F36;"><?php echo $lang['cms_text_remove'];?></a> <a href="#"> </a>
              <?php } ?>
