...
$lang['weixin_appid']    	 		= '应用标识';
$lang['weixin_appkey']    	 		= '应用密钥';
$lang['weixin_appid_error']    	 	= '请添加应用标识';
$lang['weixin_appkey_error']    	= '请添加应用密钥';
$lang['weixin_ucenter_error']    	 	= '请关闭会员整合，才可启用QQ互联功能';
...
$lang['ftp_attach_dir_tip'] 	= '遠程附件目錄的絶對路徑或相對於 FTP 主目錄的相對路徑，如果是根目錄請填"/"，非根目錄，請保證伺服器端該目錄已存在，結尾不需要"/"，如"/upload/zjcuntao"';
$lang['ftp_access_url_tip'] = '支持 HTTP 和 FTP 協議，結尾不要加斜杠“/”；如果使用 FTP 協議，FTP 伺服器必需支持 PASV 模式，為了安全起見，使用 FTP 連接的帳號不要設置可寫權限和列表權限。如果是根目錄，直接輸入域名即可，如“http://www.zjcuntao.com”，如果非根目錄，需要填寫域名+目錄形式，如“http://www.zjcuntao.com/upload/zjcuntao”';
