      ...
      <td colspan="2" height="90" class="mainhd"><div class="layout-header"> <!-- Title/Logo - can use text instead of image -->
          ...
          <div id="topnav" class="top-nav">
            <ul>
              ...
              <li><a href="index.php?act=index&op=logout" title="<?php echo $lang['nc_logout'];?>" style="padding-right: 10px;"><span><?php echo $lang['nc_logout'];?></span></a></li>
            </ul>
          </div>
          ...
          <div class="toolbar">
            ...
            <div class="sitemap" style="padding-right: 15px;"><a id="siteMapBtn" href="#rhis" onclick="showBg('dialog','dialog_content');"><span><?php echo $lang['nc_sitemap'];?></span></a></div>
          </div>
        </div>
        <div > </div></td>
    </tr>
