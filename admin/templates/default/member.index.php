      ...
      <tbody>
        <tr>
          ...
          <td><select name="search_state" >
              ...
              <option <?php if($_GET['search_state'] == 'is_station'){ ?>selected='selected'<?php } ?> value="is_station"><?php echo $lang['member_index_is_station']; ?></option>
              <option <?php if($_GET['search_state'] == 'has_station'){ ?>selected='selected'<?php } ?> value="has_station"><?php echo $lang['member_index_has_station']; ?></option>
            </select></td>
    ...
    <table class="table tb-type2 nobdb">
      <thead>
        <tr class="thead">
          ...
          <th class="align-center">站长</th>
          <th class="align-center">自提点</th>
          <th class="align-center">购买批发</th>
      ...
      <tbody>
        ...
        <tr class="hover member">
          ...
          <td class="yes-onoff align-center">
              <?php if($v['member_is_station'] == '0'){ ?>
                  <a href="JavaScript:void(0);" class=" disabled" ajax_branch='station' nc_type="inline_edit" fieldname="member_is_station" fieldid="<?php echo $v['member_id']?>" fieldvalue="0" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
              <?php }else { ?>
                  <a href="JavaScript:void(0);" class=" enabled" ajax_branch='station' nc_type="inline_edit" fieldname="member_is_station" fieldid="<?php echo $v['member_id']?>" fieldvalue="1" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
              <?php } ?>
          </td>
          <td class="yes-onoff align-center">
              <?php if($v['member_has_station'] == '0'){ ?>
                  <a href="JavaScript:void(0);" class=" disabled" ajax_branch='delivery' nc_type="inline_edit" fieldname="member_has_station" fieldid="<?php echo $v['member_id']?>" fieldvalue="0" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
              <?php }else { ?>
                  <a href="JavaScript:void(0);" class=" enabled" ajax_branch='delivery' nc_type="inline_edit" fieldname="member_has_station" fieldid="<?php echo $v['member_id']?>" fieldvalue="1" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
              <?php } ?>
          </td>
          <td class="align-center"><?php echo $v['wholesale']?'允许':'禁止';?></td>
