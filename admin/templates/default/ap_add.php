            ...
            <td class="vatop rowform "><ul>
                    <?php if(is_array($output['site_list'])){ ?>
                        <?php foreach($output['site_list'] as $k => $v){ ?>
                            <li>
                                <input type="radio" <?php if($v['site_id'] == 0){ ?>checked="checked"<?php } ?> value="<?php echo $v['site_id'];?>" name="site_id" id="site_id<?php echo $v['site_id'];?>">
                                <label for="site_id<?php echo $v['site_id'];?>"><?php echo $v['site_name'];?></label>
                            </li>
                        <?php } ?>
                    <?php } ?>
                </ul></td>
            <td class="vatop tips">默认选择为总站</td>
        </tr>
      </tbody>
      <tbody id="ap_display">
        <tr>
