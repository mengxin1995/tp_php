...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['admin_partner_parameter_allapply'];?></span></a></li>
    ...
    <table class="table tb-type2" id="prompt">
        ...
        <tr>
            <td>
                <ul>
                    <li>可以点击查看浏览服务站的详细信息,进行审核、删除等操作</li>
                </ul></td>
        </tr>
        </tbody>
    </table>
            ...
            <?php foreach($output['list'] as $k => $v){?>
                <tr class="hover">
                    ...
                    <td class="w72 align-center">
                        ...
                        <?php } else { ?>
                            <a href="index.php?act=partner&op=partner_detail&partner_id=<?php echo $v['partner_id'];?>">编辑</a>
                        <?php } ?>
                    </td>
                </tr>
            <?php } ?>
