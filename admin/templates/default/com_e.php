...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                ...
                <li><a href="JavaScript:void(0);" class="current"><span>组别E</span></a></li>
            </ul>
        </div>
    </div>
    ...
    <form method="get" name="formSearch" id="formSearch" action="index.php?act=store&op=com_e">
        <input type="hidden" value="store" name="act">
        <input type="hidden" value="com_e" name="op">
