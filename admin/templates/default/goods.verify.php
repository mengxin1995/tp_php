    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w60"><div class="goods-picture"><span class="thumb size-goods"><i></i><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $output['storage_array'][$v['goods_commonid']]['goods_id']));?>" target="_blank"><img src="<?php echo thumb($v, 60);?>" onload="javascript:DrawImage(this,56,56);"/></a></span></div></td>
          <td><dl class="goods-info">
              <dt class="goods-name"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $output['storage_array'][$v['goods_commonid']]['goods_id']));?>" target="_blank"><?php echo $v['goods_name'];?></a></dt>
              <dd class="goods-type">
          ...
          <td class="align-center"><p><?php echo $output['verify'][$v['goods_verify']];?></p>
            ...
            <?php }?></td>
           <!-- 更改按钮样式-->
            <td class="align-center"> <a href="javascript:void(0);" class="btn"  onclick="goods_verify(<?php echo $v['goods_commonid'];?>);"><span>审核</span></a></td>
