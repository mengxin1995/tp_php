    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          ...
          <th><?php echo $lang['goods_index_brand'];?>&<?php echo $lang['goods_index_class_name'];?></th>
            <th class="w72 align-center">锁定状态</th>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w60 picture"><div class="size-56x56"><span class="thumb size-56x56"><i></i><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $output['storage_array'][$v['goods_commonid']]['goods_id']));?>" target="_blank"><img src="<?php echo thumb($v, 60);?>" onload="javascript:DrawImage(this,56,56);"/></a></span></div></td>
          <td>
          <dl class="goods-info"><dt class="goods-name"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $output['storage_array'][$v['goods_commonid']]['goods_id']));?>" target="_blank"><?php echo $v['goods_name'];?></a></dt>
          <dd class="goods-type">
          ...
          <td>
            ...
            <!--商品锁定编辑开始 -->
            <td class="align-center"><?php if($v['goods_lock']==1){ echo '全部锁定<br />'; }elseif($v['goods_lock']==2){echo '价格锁定<br />';}elseif($v['goods_lock']==3){echo '库存锁定<br />';}elseif($v['goods_lock']==4){echo '价格库存锁定<br />';}else{echo '未锁定<br />';} ?><a href="<?php echo urlAdmin('goods', 'goods_lock_edit', array('goods_id' => $output['storage_array'][$v['goods_commonid']]['goods_id']));?>" >编辑</a></td>
            <!--商品锁定编辑结束 -->
