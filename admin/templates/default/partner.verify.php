  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="<?php echo urlAdmin('partner', 'partner', array('type' => 'lockup'));?>"><span><?php echo $lang['admin_partner_parameter_editapply'];?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['admin_partner_parameter_waitapply'];?></span></a></li>
      </ul>
    </div>
  </div>
...
<script language="javascript">
    ...
    // 服务站审核
    function partner_verify(ids) {
        _uri = "<?php echo ADMIN_SITE_URL;?>/index.php?act=partner&op=partner_verify&partner_id=" + ids;
        CUR_DIALOG = ajax_form('partner_verify', '审核服务站', _uri, 350);
    }
</script>