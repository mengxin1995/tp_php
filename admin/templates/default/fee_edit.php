...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['fee_edit'];?></span></a><em></em></li>
      </ul>
    </div>
  </div>
  ...
  <form id="link_form" enctype="multipart/form-data" method="post">
    ...
    <input type="hidden" name="fee_id" value="<?php echo $output['fee_info']['id'];?>" />
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="fee_name" id="fee_name" class="txt" value="<?php echo $output['fee_info']['title'];?>">
            </td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><select name="send_area" id="send_area">
              ...
              foreach ($output['province_list'] as $k=>$v){
                  echo "<option value='".$k."'";
                  if($k==$output['fee_info']['send_area_id']){echo 'selected';}
                  echo " >".$v;
                  echo "</option>";
              }
              ?>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><select name="receive_area" id="receive_area" notequalTo="#send_area">
              ...
              foreach ($output['province_list'] as $k=>$v){
                  echo "<option value='".$k."'";
                  if($k==$output['fee_info']['receive_area_id']){echo 'selected';}
                  echo " >".$v;
                  echo "</option>";
              }
              ?>
        ...
        <tr class="noborder">
            <td class="vatop rowform"><input type="text" name="fee_goods_id" id="fee_goods_id" class="txt" value="<?php echo $output['fee_info']['goods_id'];?>">
            </td>
            <td class="vatop tips"></td>
        </tr>
