  ...
  <div class="fixed-empty"></div>
   <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <li>所属大区为默认的全国性的几大区域，只有一级地区才需要填写大区域，目前全国几大区域有：华北、东北、华东、华南、华中、西南、西北、港澳台、海外</li>
      <li>所在层级为该地区的所在的层级深度，如诸暨市&gt;赵家镇&gt;菩提,其中诸暨市层级为1，赵家镇层级为2，菩提层级为3</li>
  ...
  <form method='post'>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          <td class="w60"><input type="checkbox" name="check_area_id[]" value="<?php echo $v['area_id'];?>" class="checkitem">
