  ...
  <form id="post_form" method="post" name="form1" action="<?php echo urlAdmin('mb_payment', 'payment_save');?>">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr>
            <td colspan="2" class="required"><label class="validation">商户ID</label> </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input name="wxpay_mchid" id="wxpay_mchid" value="<?php echo $output['payment']['payment_config']['wxpay_mchid'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
            <td colspan="2" class="required"><label class="validation">交易安全校验码（key）: </label></td>
        ...
        <tr>
            <td colspan="2" class="required"><label class="validation">SECRET: </label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input name="wxpay_secret" id="wxpay_secret" value="<?php echo $output['payment']['payment_config']['wxpay_secret'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <?php } ?>
        <?php if ($output['payment']['payment_code'] == 'sfpay') { ?>
        <tr>
            <td colspan="2" class="required"><label class="validation">顺手付商户号:</label> </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input name="sfpay_mchid" id="sfpay_mchid" value="<?php echo $output['payment']['payment_config']['sfpay_mchid'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
            <td colspan="2" class="required"><label class="validation">顺手付商户名:</label> </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input name="sfpay_mchname" id="sfpay_mchname" value="<?php echo $output['payment']['payment_config']['sfpay_mchname'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
            <td colspan="2" class="required"><label class="validation">顺手付密钥:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input name="sfpay_key" id="sfpay_key" value="<?php echo $output['payment']['payment_config']['sfpay_key'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <?php } ?>
