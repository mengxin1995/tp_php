...
<?php } ?>
        ...
        <td class="align-center">
            ...
            <?php } ?>
            <?php if($val['restartable']) { ?>
            <a nctype="btn_restart" data-groupbuy-id="<?php echo $val['groupbuy_id'];?>" href="javascript:;">重启</a>
            <?php } ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('[nctype="btn_restart"]').on('click', function() {
            if(confirm('确认重启该抢购活动？')) {
                var action = '<?php echo urlAdmin('groupbuy', 'groupbuy_restart');?>';
                var groupbuy_id = $(this).attr('data-groupbuy-id');
                $('#op_form').attr('action', action);
                $('#groupbuy_id').val(groupbuy_id);
                $('#op_form').submit();
