...
$(function(){
    ...
    $('#brand_div').load("<?php echo ADMIN_SITE_URL;?>/index.php?act=brand&op=getBrandList",function(){
...
function brand_scroll(o){
	var id = o.val();
    $('#brand_div').load("<?php echo ADMIN_SITE_URL;?>/index.php?act=brand&op=getBrandList&class_id="+id,function(){
