    ...
    <tbody>
      ...
      <tr>
        <td><ul>
            ...
            <li><strong><?php echo $lang['address'];?><?php echo $lang['nc_colon'];?></strong><?php echo @$output['order_info']['extend_order_common']['reciver_info']['address'];?>
                <?php if($output['order_info']['extend_order_common']['reciver_info']['station_name']!=''){?>
                &nbsp;站长姓名：<?php echo @$output['order_info']['extend_order_common']['reciver_info']['station_name'];?>,&nbsp;电话：<?php echo @$output['order_info']['extend_order_common']['reciver_info']['mob_phone'];?>
                <?php }?>
            </li>
...
<script>
$(function(){
      var_send = '<li><?php echo date("Y-m-d H:i:s",$output['order_info']['extend_order_common']['shipping_time']); ?>&nbsp;&nbsp;卖家已发货</li>';
	$.getJSON('index.php?act=order&op=get_express&e_code=<?php echo $output['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo random(7);?>',function(data){
		if(data){
			data = var_send+data;
