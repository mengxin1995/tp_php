    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <span id="region" class="w400">
          ...
          <tr>
          <td colspan="2" class="required"><label class="member_mobile"><?php echo $lang['member_index_mobile']?></label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
            <td colspan="2" class="required"><label class="member_rate"><?php echo $lang['member_edit_rate']?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['member_array']['member_rate'];?>" id="member_rate" name="member_rate" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" class="required"><label><?php echo '购买批发';?>:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform onoff">
                <label for="wholesale1" class="cb-enable <?php if($output['member_array']['wholesale'] == '1'){ ?>selected<?php } ?>" ><span><?php echo '允许';?></span></label>
                <label for="wholesale0" class="cb-disable <?php if($output['member_array']['wholesale'] == '0'){ ?>selected<?php } ?>" ><span><?php echo '禁止';?></span></label>
                <input id="wholesale1" name="wholesale" <?php if($output['member_array']['wholesale'] == '1'){ ?>checked="checked"<?php } ?> value="1" type="radio">
                <input id="wholesale0" name="wholesale" <?php if($output['member_array']['wholesale'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio">
            <td class="vatop tips"></td>
        </tr>
        <tr>
...
$("#submitBtn").click(function(){
    ...
    $('#user_form').validate({
        ...
        messages : {
            ...
            member_rate : {
                required: '<?php echo $lang['member_edit_rate_required']?>',
                number: '<?php echo $lang['member_edit_rate_number']?>',
                range: '<?php echo $lang['member_edit_rate_range']?>'
            },
            member_email  : {
