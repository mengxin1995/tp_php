    ...
    <ul class="home-templates-board-style">
      <?php if(is_array($output['site_list'])){ ?>
        <?php foreach($output['site_list'] as $k => $v){ ?>
          <li class="blue <?php if($output['site_id'] == $v['site_id']){ ?> selected <?php } ?> "><a href="index.php?act=web_api&op=sale_edit&site_id=<?php echo $v['site_id'];?>"><em></em><i class="icon-ok"></i><?php echo $v['site_name'];?></a></li>
        <?php } ?>
      <?php } ?>
    </ul>
  </div>
