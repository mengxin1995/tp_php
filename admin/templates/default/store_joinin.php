      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w72 align-center">
            <?php if(in_array(intval($v['joinin_state']), array(STORE_JOIN_STATE_NEW, STORE_JOIN_STATE_VERIFY_FAIL,STORE_JOIN_STATE_PAY_FAIL))) { ?>
              <a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?act=store&op=del_join&id=<?php echo $v['member_id'];?>';}else{return false;}">删除</a>
            <?php } ?>
