      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:void(0);" id="ncsubmit" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            <?php if($output['search_spec_name'] != ''){?>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w48 sort"><span class=" <?php if($val['sp_id'] != '1'){?>editable<?php }?>" maxvalue="255" <?php if($val['sp_id'] != '1'){?> title="<?php echo $lang['nc_editable'];?>" datatype="pint" fieldid="<?php echo $val['sp_id'];?>" ajax_branch="sort" fieldname="sp_sort" nc_spec="inline_edit"<?php }?>><?php echo $val['sp_sort'];?></span></td>
