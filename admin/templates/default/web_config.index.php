...
<div class="page">
  ...
  <table class="table tb-type2" id="prompt">
    ...
    <table class="table tb-type2" id="index_site">
    <tbody>
      <tr class="space odd">
        <th colspan="12"><div class="title"><h5><?php echo $lang['web_config_index_site'];?></h5><span class="arrow"></span></div></th>
      </tr>
      <tr>
        <td>
          <ul class="home-templates-board-style">
            <?php if(is_array($output['site_list'])){ ?>
              <?php foreach($output['site_list'] as $k => $v){ ?>
                <li class="purple <?php if($output['site_id'] == $v['site_id']){ ?> selected <?php } ?> "><a href="index.php?act=web_config&op=web_config&site_id=<?php echo $v['site_id'];?>"><em></em><i class="icon-ok"></i><?php echo $v['site_name'];?></a></li>
              <?php } ?>
            <?php } ?>
          </ul>
        </td>
    ...
    <table class="table tb-type2 nobdb">
      <thead>
        <tr class="thead">
          ...
          <th class="align-center"><?php echo $lang['web_config_index_site'];?></th>
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w100 align-center"><?php echo $v['web_show']==1 ? $lang['nc_yes'] : $lang['nc_no'];?></td>
          <td class="w48 align-center"><?php echo $output['site_list'][$v['site_id']]['site_name'];?></td>
