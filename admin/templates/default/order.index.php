      ...
      <tbody>
        ...
        <tr>
          ...
          <td><input class="txt date" type="text" value="<?php echo $_GET['query_start_time'];?>" id="query_start_time" name="query_start_time">
            ...
            <!--订单总额区间开始-->
            <th><label for="query_start_price"><?php echo '订单总额';?></label></th>
            <td><input class="txt-short" type="text" value="<?php echo $_GET['query_start_price'];?>" id="query_start_price" name="query_start_price">
                <label for="query_start_price">~</label>
                <input class="txt-short" type="text" value="<?php echo $_GET['query_end_price'];?>" id="query_end_price" name="query_end_price"/></td>
            <!--订单总额区间结束-->
