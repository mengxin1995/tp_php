  ...
  <form id="post_form" method="post" name="form1">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <?php } elseif ($output['payment']['payment_code'] == 'sfpay') { ?>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_sfpay_account'];?>:
            </th></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="hidden" name="config_name" value="sfpay_account,sfpay_key" />
            <input name="sfpay_account" id="sfpay_account" value="<?php echo $output['config_array']['sfpay_account'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_sfpay_key'];?>: </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input name="sfpay_key" id="sfpay_key" value="<?php echo $output['config_array']['sfpay_key'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
...
$(document).ready(function(){
	$('#post_form').validate({
        ...
        messages : {
            sfpay_account  : {
                required  : '<?php echo $lang['payment_sfpay_account'];?><?php echo $lang['payment_edit_not_null']; ?>'
            },
            sfpay_key  : {
                required   : '<?php echo $lang['payment_sfpay_key'];?><?php echo $lang['payment_edit_not_null']; ?>'
            }
        }
		<?php } elseif ($output['payment']['payment_code'] == 'tenpay') { ?>
        rules : {
