...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3><?php echo '计算机';?></h3>
            <ul class="tab-base">
                <li><a href="index.php?act=store&op=com_a" ><span>组别A</span></a></li>
                <li><a href="index.php?act=store&op=com_b" ><span>组别B</span></a></li>
                <li><a href="index.php?act=store&op=com_c" ><span>组别C</span></a></li>
                <li><a href="JavaScript:void(0);" class="current"><span>组别D</span></a></li>
    ...
    <form method="get" name="formSearch" id="formSearch" action="index.php?act=store&op=com_d">
        <input type="hidden" value="store" name="act">
        <input type="hidden" value="com_d" name="op">
