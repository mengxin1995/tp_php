    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          ...
          <th><label><?php echo $lang['navigation_index_site'];?></label></th>
          <td><select name="search_site_id">
              <option value=""><?php echo $lang['nc_please_choose'];?>...</option>
              <?php if(is_array($output['site_list'])){ ?>
                <?php foreach($output['site_list'] as $k => $v){ ?>
                    <option value="<?php echo $v['site_id']; ?>" <?php if($output['site_id'] == $v['site_id']){ ?>selected="selected"<?php } ?> ><?php echo $v['site_name'];?></option>
                <?php } ?>
              <?php } ?>
            </select></td>
    ...
    <table class="table tb-type2">
      <thead>
        ...
        <tr class="thead">
          ...
          <th class="align-center"><?php echo $lang['navigation_index_site'];?></th>
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w150 align-center"><?php echo $output['site_list'][$v['site_id']]['site_name'];?></td>
