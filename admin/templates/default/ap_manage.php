...
<div class="page">
 ...
 <!-- 增加分站开始-->
  <table class="table tb-type2" id="index_site">
    <tbody>
    <tr class="space odd">
      <th colspan="12"><div class="title"><h5><?php echo $lang['adv_index_site'];?></h5><span class="arrow"></span></div></th>
    </tr>
    <tr>
      <td>
        <ul class="home-templates-board-style">
          <?php if(is_array($output['site_list'])){ ?>
            <?php foreach($output['site_list'] as $k => $v){ ?>
              <li class="purple <?php if($output['site_id'] == $v['site_id']){ ?> selected <?php } ?> "><a href="index.php?act=adv&op=ap_manage&site_id=<?php echo $v['site_id'];?>"><em></em><i class="icon-ok"></i><?php echo $v['site_name'];?></a></li>
            <?php } ?>
          <?php } ?>
        </ul>
      </td>
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          ...
          <th class="align-center"><?php echo $lang['adv_index_site'];?></th>
