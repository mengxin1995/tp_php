...
<script type="text/javascript">
    ...
    $(function(){
            ...
            if(t.value == 1){
                alert("您输入的数据不符合规范！！！");
               location.href='index.php?act=store&op=store_yujing';
            }
        }
    )
</script>
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3><?php echo '设置';?></h3>
            <ul class="tab-base">
                <li><a href="JavaScript:void(0);" class="current"><span>新建规则</span></a></li>
            </ul>
        </div>
    </div>
    <div class="homepage-focus" nctype="editStoreContent">
        <form id="store_form" method="post" action="index.php?act=store&op=store_shezhiyujing">
