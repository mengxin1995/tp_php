...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3><?php echo '计算机';?></h3>
            <ul class="tab-base">
                <li><a href="JavaScript:void(0);" class="current"><span>监控</span></a></li>
                <li><a href="index.php?act=store&op=newcom_add" ><span>新建节点</span></a></li>
            </ul>
        </div>
    </div>
    ...
    <form method="get" name="formSearch" id="formSearch" action="index.php?act=store&op=store">
