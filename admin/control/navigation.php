...
class navigationControl extends SystemControl{
	...
	public function navigationOp(){
		...
		$condition['site_id'] = trim($_GET['search_site_id']);
		...
		Tpl::output('site_id',trim($_GET['search_site_id']));
	...
	public function navigation_addOp(){
		...
		if (chksubmit()){
			...
			if ($error != ''){
				...
				$insert_array['site_id'] = trim($_POST['site_id']);
				switch ($_POST['nav_type']){
					/**
					 * 自定义
					 */
	...
	public function navigation_editOp(){
		...
		if (chksubmit()){
			...
			if ($error != ''){
				...
				$update_array['site_id'] = trim($_POST['site_id']);
				switch ($_POST['nav_type']){
					/**
					 * 自定义
					 */
